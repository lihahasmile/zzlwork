...
ffffffffc0200b1c:	06900593          	li	a1,105
...
ffffffffc0200ddc:	10700593          	li	a1,263
...
ffffffffc0200dfc:	0d300593          	li	a1,211
...
ffffffffc0200e1c:	0d400593          	li	a1,212
...
ffffffffc0200e5c:	0ef00593          	li	a1,239
...
ffffffffc0200e7c:	0d100593          	li	a1,209
...
ffffffffc0200e9c:	14900593          	li	a1,329
...
ffffffffc0200ebc:	10a00593          	li	a1,266
...
ffffffffc0200edc:	0d000593          	li	a1,208
...
ffffffffc0200efc:	0cf00593          	li	a1,207
...
ffffffffc0200f1c:	0ec00593          	li	a1,236
...
ffffffffc0200f3c:	0ea00593          	li	a1,234
...
ffffffffc0200f5c:	0e900593          	li	a1,233
...
ffffffffc0200f7c:	0e800593          	li	a1,232
...
ffffffffc0200f9c:	0e600593          	li	a1,230
...
ffffffffc0200fbc:	0e100593          	li	a1,225
...
ffffffffc0200fdc:	0d800593          	li	a1,216
...
ffffffffc0200ffc:	0d700593          	li	a1,215
...
ffffffffc020101c:	14800593          	li	a1,328
...
ffffffffc020103c:	13d00593          	li	a1,317
...
ffffffffc020105c:	13700593          	li	a1,311
...
ffffffffc020107c:	13600593          	li	a1,310
...
ffffffffc020109c:	12e00593          	li	a1,302
...
ffffffffc02010bc:	12d00593          	li	a1,301
...
ffffffffc02010dc:	12c00593          	li	a1,300
...
ffffffffc02010fc:	12a00593          	li	a1,298
...
ffffffffc020111c:	12900593          	li	a1,297
...
ffffffffc020113c:	11d00593          	li	a1,285
...
ffffffffc020115c:	11400593          	li	a1,276
...
ffffffffc020117c:	11300593          	li	a1,275
...
ffffffffc020119c:	0f500593          	li	a1,245
...
ffffffffc02011bc:	0f300593          	li	a1,243
...
ffffffffc02011dc:	0f200593          	li	a1,242
...
ffffffffc020125a:	06d70363          	beq	a4,a3,ffffffffc02012c0 <best_fit_free_pages+0xd4>
    for (; p != base + n; p ++) {
...
ffffffffc0201276:	ed18                	sd	a4,24(a0)
    if (le != &free_list) {
ffffffffc0201278:	02d70163          	beq	a4,a3,ffffffffc020129a <best_fit_free_pages+0xae>
        p = le2page(le, page_link);
ffffffffc020127c:	fe870613          	addi	a2,a4,-24 # ffffffffffffefe8 <end+0x3fdf8b78>
         if ((unsigned int)(base - p) == p->property) {
ffffffffc0201280:	40c507b3          	sub	a5,a0,a2
ffffffffc0201284:	00001597          	auipc	a1,0x1
ffffffffc0201288:	5745b583          	ld	a1,1396(a1) # ffffffffc02027f8 <nbase+0x8>
ffffffffc020128c:	878d                	srai	a5,a5,0x3
ffffffffc020128e:	02b787bb          	mulw	a5,a5,a1
ffffffffc0201292:	ff872583          	lw	a1,-8(a4)
ffffffffc0201296:	02b78f63          	beq	a5,a1,ffffffffc02012d4 <best_fit_free_pages+0xe8>
    return listelm->next;
ffffffffc020129a:	7118                	ld	a4,32(a0)
    if (le != &free_list) {
ffffffffc020129c:	00d70f63          	beq	a4,a3,ffffffffc02012ba <best_fit_free_pages+0xce>
        if (base + base->property == p) {
ffffffffc02012a0:	490c                	lw	a1,16(a0)
        p = le2page(le, page_link);
ffffffffc02012a2:	fe870693          	addi	a3,a4,-24
        if (base + base->property == p) {
ffffffffc02012a6:	02059613          	slli	a2,a1,0x20
ffffffffc02012aa:	9201                	srli	a2,a2,0x20
ffffffffc02012ac:	00261793          	slli	a5,a2,0x2
ffffffffc02012b0:	97b2                	add	a5,a5,a2
ffffffffc02012b2:	078e                	slli	a5,a5,0x3
ffffffffc02012b4:	97aa                	add	a5,a5,a0
ffffffffc02012b6:	04f68763          	beq	a3,a5,ffffffffc0201304 <best_fit_free_pages+0x118>
}
ffffffffc02012ba:	60a2                	ld	ra,8(sp)
ffffffffc02012bc:	0141                	addi	sp,sp,16
ffffffffc02012be:	8082                	ret
    prev->next = next->prev = elm;
ffffffffc02012c0:	e790                	sd	a2,8(a5)
    elm->next = next;
ffffffffc02012c2:	f114                	sd	a3,32(a0)
    return listelm->next;
ffffffffc02012c4:	6798                	ld	a4,8(a5)
    elm->prev = prev;
ffffffffc02012c6:	ed1c                	sd	a5,24(a0)
        while ((le = list_next(le)) != &free_list) {
ffffffffc02012c8:	02d70463          	beq	a4,a3,ffffffffc02012f0 <best_fit_free_pages+0x104>
    prev->next = next->prev = elm;
ffffffffc02012cc:	8832                	mv	a6,a2
ffffffffc02012ce:	4585                	li	a1,1
    for (; p != base + n; p ++) {
ffffffffc02012d0:	87ba                	mv	a5,a4
ffffffffc02012d2:	b779                	j	ffffffffc0201260 <best_fit_free_pages+0x74>
            p->property += base->property;
ffffffffc02012d4:	490c                	lw	a1,16(a0)
ffffffffc02012d6:	9fad                	addw	a5,a5,a1
ffffffffc02012d8:	fef72c23          	sw	a5,-8(a4)
    __op_bit(and, __NOT, nr, ((volatile unsigned long *)addr));
ffffffffc02012dc:	57f5                	li	a5,-3
ffffffffc02012de:	60f8b02f          	amoand.d	zero,a5,(a7)
    __list_del(listelm->prev, listelm->next);
ffffffffc02012e2:	6d0c                	ld	a1,24(a0)
ffffffffc02012e4:	711c                	ld	a5,32(a0)
            base = p;
ffffffffc02012e6:	8532                	mv	a0,a2
    prev->next = next;
ffffffffc02012e8:	e59c                	sd	a5,8(a1)
    return listelm->next;
ffffffffc02012ea:	6718                	ld	a4,8(a4)
    next->prev = prev;
ffffffffc02012ec:	e38c                	sd	a1,0(a5)
ffffffffc02012ee:	b77d                	j	ffffffffc020129c <best_fit_free_pages+0xb0>
...
ffffffffc0201334:	08f00593          	li	a1,143
...
ffffffffc0201354:	08c00593          	li	a1,140
